class Main extends egret.DisplayObjectContainer {
    ...
    private createGameScene(): void {
        ...
        GameScene.getCurrentScene().userSystem.tileMap.addEventListener(egret.TouchEvent.TOUCH_TAP, (e) => {
        ...
        GameScene.getCurrentScene().userSystem.NPC_0.addEventListener(egret.TouchEvent.TOUCH_TAP, (e) => {
        ...
        GameScene.getCurrentScene().userSystem.NPC_1.addEventListener(egret.TouchEvent.TOUCH_TAP, (e) => {
        ...
        GameScene.getCurrentScene().userSystem.monster.addEventListener(egret.TouchEvent.TOUCH_TAP, (e) => {
            list.addCommand(new WalkCommand(e.stageX, e.stageY));
            list.addCommand(new FightCommand());
            list.execute();
        }, this);

           GameScene.getCurrentScene().userSystem.equipmentButton.addEventListener(egret.TouchEvent.TOUCH_TAP, (e) => {
            list.addCommand(new WalkCommand(e.stageX, e.stageY));
